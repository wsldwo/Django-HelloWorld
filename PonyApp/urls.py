...
urlpatterns = [
    path('pony/',views.pony,name='pony_home'),#name="路由别名"
    path('pony_search/',views.pony_search,name='pony_search'),
    path('pony_insert/',views.pony_insert,name='pony_insert'),
    path('pony_test/',views.pony_test,name='pony_test')
]
